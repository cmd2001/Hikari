...
function optionsframework_options()
{
    ...
    $options[] = array(
        ...
        'desc' => __('最佳高度尺寸40px，不上传图标默认显示网站名称(文字)', 'options_framework_theme'),
        'id' => 'akina_logo',
        'type' => 'upload'
    );
    ...
    $options[] = array(
        'name' => __('搜索', 'options_framework_theme'),
        'id' => 'top_search',
        'std' => "yes",
        'type' => "radio",
        'options' => array(
    ...
    $options[] = array(
        'name' => __('说说', 'options_framework_theme'),
        'id' => 'shuoshuo',
        'std' => "no",
        'type' => "radio",
        'options' => array(
    ...
    $options[] = array(
        'name' => __('背景风格', 'options_framework_theme'),
        'id' => 'background_style',
        'std' => "blur",
        'type' => "radio",
        'options' => array(
    ...
    $options[] = array(
        'name' => __('博主格言', 'options_framework_theme'),
        'desc' => __('首页头像框下显示的话', 'options_framework_theme'),
        'id' => 'admin_des',
        'std' => '卡永远是你的问题，而不是我的',
        'type' => 'textarea'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('页脚说明文字，如版权信息等。支持HTML代码', 'options_framework_theme'),
        'id' => 'footer_info',
        'std' => 'Copyright &copy; by Amagi_Yukisaki All Rights Reserved. 2020-2020',
        'type' => 'textarea'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('日期格式：2020-01-01(年-月-日)', 'options_framework_theme'),
        'id' => 'web_buildtime',
        'std' => '2020-01-01',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('统计JS URL', 'options_framework_theme'),
    ...
    $options[] = array(
        'name' => __('网页分析', 'options_framework_theme'),
    ...
    $options[] = array(
        ...
        'desc' => __('直接填写css代码，无需标签，在前台展示页面生效', 'options_framework_theme'),
    ...
    $options[] = array(
        ...
        'desc' => __('直接填写css代码，无需HTML标签，仅对模糊配色后生效', 'options_framework_theme'),
    ...
    $options[] = array(
        'name' => __('总开关(头像框、社交信息和模糊背景等)', 'options_framework_theme'),
        'desc' => __('默认开启，勾选关闭，仅在pc端生效', 'options_framework_theme'),
        'id' => 'head_focus',
        'std' => '0',
        'type' => 'checkbox'
    );
    ...
    */
    ...
    $options[] = array(
        ...
        'desc' => __('这里填入一个图片api地址，仅支持静态url', 'options_framework_theme'),
        'id' => 'focus_img_0',
        'std' => '',
        'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('微信收款码：我很可爱，请给我钱～', 'options_framework_theme'),
        'id' => 'wechat_code',
        'type' => 'upload'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('支付宝收款码：我很可爱，请给我钱～', 'options_framework_theme'),
        'id' => 'alipay_code',
        'type' => 'upload'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('默认为聚焦，你可以自行修改，当然可以当广告用，这是你的自由', 'options_framework_theme'),
        'id' => 'feature_title',
        'std' => '聚焦',
        'class' => 'mini',
        'type' => 'text'
    ...
    $options[] = array(
        'name' => __('聚焦一图片', 'options_framework_theme'),
        'desc' => __('推荐尺寸322*160，过大过小均无法正常显示', 'options_framework_theme'),
        'id' => 'feature1_img',
    ...
    $options[] = array(
        'name' => __('聚焦一标题', 'options_framework_theme'),
        'desc' => __('聚焦一标题', 'options_framework_theme'),
        'id' => 'feature1_title',
        'std' => '聚焦',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('聚焦一链接', 'options_framework_theme'),
        'desc' => __('聚焦一链接', 'options_framework_theme'),
        'id' => 'feature1_link',
        'std' => '',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('聚焦二图片', 'options_framework_theme'),
        'desc' => __('推荐尺寸322*160，过大过小均无法正常显示', 'options_framework_theme'),
        'id' => 'feature2_img',
        'std' => $imagepath . 'temp.jpg',
        'type' => 'upload'
    ...
    $options[] = array(
        'name' => __('聚焦二标题', 'options_framework_theme'),
        'desc' => __('聚焦二标题', 'options_framework_theme'),
        'id' => 'feature2_title',
        'std' => '聚焦',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('聚焦二链接', 'options_framework_theme'),
        'desc' => __('聚焦二链接', 'options_framework_theme'),
        'id' => 'feature2_link',
        'std' => '',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('聚焦三图片', 'options_framework_theme'),
        'desc' => __('推荐尺寸322*160，过大过小均无法正常显示', 'options_framework_theme'),
        'id' => 'feature3_img',
        'std' => $imagepath . 'temp.jpg',
        'type' => 'upload'
    ...
    $options[] = array(
        'name' => __('聚焦三标题', 'options_framework_theme'),
        'desc' => __('聚焦三标题', 'options_framework_theme'),
        'id' => 'feature3_title',
        'std' => '聚焦',
        'type' => 'text'
    );
    ...
    $options[] = array(
        'name' => __('聚焦三链接', 'options_framework_theme'),
        'desc' => __('聚焦三链接', 'options_framework_theme'),
        'id' => 'feature3_link',
        'std' => '',
        'type' => 'text'
    );
    ...
    */
    ...
    $options[] = array(
        ...
        'desc' => __('该功能仅在pc端有效果', 'options_framework_theme'),
        'id' => 'click_effect',
        'std' => "off",
        'type' => "radio",
        'options' => array(
    ...
    */
    ...
    $options[] = array(
        ...
        'desc' => __('用于发送系统邮件，在用户的邮箱中显示的发件人地址，不要使用中文，默认系统邮件地址为“Poi@你的域名.com”，仅适用于 WordPress 不需要装插件就能发信的服务器，但会被当作垃圾邮件对待～', 'options_framework_theme'),
        'id' => 'mail_user_name',
        'std' => 'Poi',
        'type' => 'text'
    );
    ...
    $options[] = array(
        ...
        'desc' => __('默认关闭，勾选开启，仅支持 Chrome 内核的浏览器（例如新Edge）', 'options_framework_theme'),
        'id' => 'slider_bar',
        'std' => '0',
        'type' => 'checkbox'
    );
