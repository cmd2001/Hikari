    ...
    <div class="site-info">
        ...
        <div class="footer-device">
            <p>
                ...
                printf(esc_html__('%1$s &nbsp; %2$s &nbsp; %3$s &nbsp; %4$s', 'akina'), $site_map_link, '<a href="https://github.com/cmd2001/Hikari/" rel="designer" target="_blank" rel="nofollow">Theme</a>', '<a href="https://wordpress.org" target="_blank" rel="nofollow">WordPress</a>', $statistics_link);
                ?>
            </p>
        </div>
        <div class="footer-device">
        ...
        <?php if (akina_option('web_runtime') != '0') { ?>
            <div class="footer-device">
                <p>娇弱的<a href="/phpsysinfo/index.php?disp=bootstrap" target="_blank">服务器</a>被持续蹂躏了 <?php echo get_web_buildtime(); ?> 天</p>
            </div>
        <?php } ?>
    </div><!-- .site-info -->
</footer><!-- #colophon -->
